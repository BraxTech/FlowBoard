...
const BoardSwitcherModal = () => {
	return (
		<div className='fixed inset-0 bg-black/50 flex items-center justify-start z-1 top-16 '>
			<div className='absolute w-[264px] py-5  h-auto max-h-[625px] rounded-xl text-gray-500 bg-white z-1  left-7 top-4 flex flex-col  pb-10 right-25 items-start space-y-3 '>
				...
				<div className='bg-gray-100 rounded w-[235px] h-[48px] self-center flex items-center justify-center'>
					<FaSun size={20} />
					<FaMoon size={20} />
				</div>
			</div>
